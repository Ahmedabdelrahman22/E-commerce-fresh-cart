...
export default function Cart() {
  ...
  const { getCartItems, updateProductCount, removeProductFromCart } = useContext(CartContext)
  ...
  return <>
    ...
    {cart ? <div className="relative  overflow-x-auto w-3/4 mx-auto">
      ...
      <button className='btn  bg-main text-white p-2 rounded py-1'><Link to={'/checkout'}>Check Out</Link></button>
